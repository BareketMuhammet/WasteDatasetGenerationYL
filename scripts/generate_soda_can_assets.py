...
from dataset.scripts.deformation_functions import *


input_dir = "/home/tem/Waste-Dataset-Generation/fbx_standard/cans"
output_dir = "/home/tem/Waste-Dataset-Generation/res_fbx_objects/cans"
prefix = "can"
start_index = 1
num_needed = 10000
seed=None
vertical_squash_probability = 0.25
...
for i in range(num_needed):
    ...
    while attempt < max_attempts_per_file:
        ...
        try:
            deform_export_soda_can(
                src,
                out_path,
                vertical_squash_probability=vertical_squash_probability,
