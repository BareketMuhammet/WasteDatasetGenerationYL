...
def make_name(prefix, idx):
    return f"{prefix}_{idx:04d}.fbx"


def deform_export_water_bottle(source_fbx_path, export_fbx_path, flatten_probability = 0.5, press_band_inward_twice_probability = 0.3, two_peaks_vertical_squash_probability = 0.3):
    """
    ...
    log(f"Exported crushed bottle to: {export_fbx_path}")
